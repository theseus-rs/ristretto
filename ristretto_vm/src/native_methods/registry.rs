...
use crate::native_methods::{
    ...
    com_sun_media_sound_portmixerprovider, com_sun_security_auth_module_unixsystem,
    ...
    java_io_console, java_io_filedescriptor, java_io_fileinputstream, java_io_fileoutputstream,
    java_io_objectinputstream, java_io_objectoutputstream, java_io_objectstreamclass,
    java_io_randomaccessfile, java_io_unixfilesystem, java_lang_class, java_lang_classloader,
    java_lang_classloader_nativelibrary, java_lang_compiler, java_lang_double, java_lang_float,
    java_lang_invoke_methodhandle, java_lang_invoke_methodhandlenatives, java_lang_object,
    java_lang_package, java_lang_processenvironment, java_lang_reflect_array,
    java_lang_reflect_executable, java_lang_reflect_field, java_lang_reflect_proxy,
    java_lang_runtime, java_lang_securitymanager, java_lang_shutdown, java_lang_strictmath,
    java_lang_string, java_lang_system, java_lang_thread, java_lang_throwable,
    java_lang_unixprocess, java_net_datagrampacket, java_net_inet4address,
    ...
    java_net_plaindatagramsocketimpl, java_net_plainsocketimpl, java_net_socketinputstream,
    java_net_socketoutputstream, java_nio_bits, java_nio_mappedbytebuffer,
    java_security_accesscontroller, java_util_concurrent_atomic_atomiclong, java_util_jar_jarfile,
    java_util_logging_filehandler, java_util_prefs_filesystempreferences,
    java_util_prefs_macosxpreferencesfile, java_util_timezone, java_util_zip_adler32,
    java_util_zip_crc32, java_util_zip_deflater, java_util_zip_inflater, java_util_zip_zipfile,
    ...
    sun_nio_ch_nativethread, sun_nio_ch_net, sun_nio_ch_pollarraywrapper, sun_nio_ch_sctp_sctpnet,
    sun_nio_ch_serversocketchannelimpl, sun_nio_ch_socketchannelimpl,
    ...
    sun_reflect_nativemethodaccessorimpl, sun_reflect_reflection,
    sun_security_jgss_wrapper_gsslibstub, sun_security_krb5_config, sun_security_krb5_credentials,
    sun_security_krb5_scdynamicstoreconfig, sun_security_smartcardio_pcsc,
    sun_security_smartcardio_platformpcsc, sun_tracing_dtrace_jvm,
    sun_util_locale_provider_hostlocaleprovideradapterimpl,
};
