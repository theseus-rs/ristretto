...
mod test {
    ...
    #[tokio::test]
    async fn test_caload() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(2);
        let reference = Reference::from(vec![42 as char]);
    ...
    #[tokio::test]
    async fn test_caload_invalid_value() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(2);
    ...
    #[tokio::test]
    async fn test_caload_invalid_index_negative() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(2);
        let reference = Reference::from(vec![42 as char]);
        let array = Value::new_object(thread.vm()?.garbage_collector(), reference);
    ...
    #[tokio::test]
    async fn test_caload_invalid_index() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(2);
        let reference = Reference::from(vec![42 as char]);
        let array = Value::new_object(thread.vm()?.garbage_collector(), reference);
    ...
    #[tokio::test]
    async fn test_castore() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(3);
        let reference = Reference::from(vec![3 as char]);
        let array = Value::new_object(thread.vm()?.garbage_collector(), reference);
        stack.push(array)?;
        stack.push_int(0)?;
        stack.push_int(42)?;
    ...
    #[tokio::test]
    async fn test_castore_invalid_value() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(3);
        let reference = Reference::from(vec![42i32]);
        let object = Value::new_object(thread.vm()?.garbage_collector(), reference);
    ...
    #[tokio::test]
    async fn test_castore_invalid_index_negative() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(3);
        let reference = Reference::from(vec![3 as char]);
        let array = Value::new_object(thread.vm()?.garbage_collector(), reference);
    ...
    #[tokio::test]
    async fn test_castore_invalid_index() -> Result<()> {
        let (_vm, thread) = crate::test::thread().await?;
        let stack = &mut OperandStack::with_max_size(3);
        let reference = Reference::from(vec![3 as char]);
        let array = Value::new_object(thread.vm()?.garbage_collector(), reference);
