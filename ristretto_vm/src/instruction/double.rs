...
/// See: <https://docs.oracle.com/javase/specs/jvms/se23/html/jvms-6.html#jvms-6.5.dstore_n>
#[inline]
pub(crate) fn dstore_0(locals: &LocalVariables, stack: &OperandStack) -> Result<ExecutionResult> {
    let value = stack.pop_double()?;
...
/// See: <https://docs.oracle.com/javase/specs/jvms/se23/html/jvms-6.html#jvms-6.5.dstore_n>
#[inline]
pub(crate) fn dstore_1(locals: &LocalVariables, stack: &OperandStack) -> Result<ExecutionResult> {
    let value = stack.pop_double()?;
...
/// See: <https://docs.oracle.com/javase/specs/jvms/se23/html/jvms-6.html#jvms-6.5.dstore_n>
#[inline]
pub(crate) fn dstore_2(locals: &LocalVariables, stack: &OperandStack) -> Result<ExecutionResult> {
    let value = stack.pop_double()?;
...
/// See: <https://docs.oracle.com/javase/specs/jvms/se23/html/jvms-6.html#jvms-6.5.dstore_n>
#[inline]
pub(crate) fn dstore_3(locals: &LocalVariables, stack: &OperandStack) -> Result<ExecutionResult> {
    let value = stack.pop_double()?;
...
mod tests {
    ...
    #[test]
    fn test_daload_invalid_value() -> crate::Result<()> {
        let stack = &mut OperandStack::with_max_size(2);
    ...
    #[test]
    fn test_daload_invalid_index() -> crate::Result<()> {
        let stack = &mut OperandStack::with_max_size(2);
        let array = Reference::DoubleArray(ConcurrentVec::from(vec![42f64]));
        stack.push_object(Some(array))?;
        stack.push_int(2)?;
    ...
    #[test]
    fn test_daload_null_pointer() -> crate::Result<()> {
        let stack = &mut OperandStack::with_max_size(2);
    ...
    #[test]
    fn test_dastore_invalid_value() -> crate::Result<()> {
        let stack = &mut OperandStack::with_max_size(3);
        let object = Reference::IntArray(ConcurrentVec::from(vec![42]));
        stack.push_object(Some(object))?;
        stack.push_int(2)?;
    ...
    #[test]
    fn test_dastore_invalid_index() -> crate::Result<()> {
        let stack = &mut OperandStack::with_max_size(3);
        let array = Reference::DoubleArray(ConcurrentVec::from(vec![3f64]));
        stack.push_object(Some(array))?;
        stack.push_int(2)?;
    ...
    #[test]
    fn test_dastore_null_pointer() -> crate::Result<()> {
        let stack = &mut OperandStack::with_max_size(3);
        stack.push_object(None)?;
        stack.push_int(0)?;
        stack.push_double(42f64)?;
