...
impl Method {
    ...
    /// Create a synthetic method for intrinsics that don't have class file entries. This is used
    /// for holder class methods that are dynamically generated by the JVM.
    #[must_use]
