...
#[async_method]
pub async fn get_tcpkeep_alive_probes_0<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
    todo!("jdk.net.MacOSXSocketOptions.getTcpkeepAliveProbes0(I)I")
...
#[async_method]
pub async fn ip_dont_fragment_supported_0<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn set_tcpkeep_alive_probes_0<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
    todo!("jdk.net.MacOSXSocketOptions.setTcpkeepAliveProbes0(II)V")
