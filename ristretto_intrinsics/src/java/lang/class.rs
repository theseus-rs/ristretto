...
///
/// # Errors
/// Returns an error if the class cannot be loaded or the object is invalid.
pub async fn get_class<T: Thread + 'static>(thread: &T, object: &Value) -> Result<Arc<Class>> {
    {
...
/// # Errors
/// Returns an error if the class cannot be loaded or the object is invalid.
pub async fn get_class_no_init<T: Thread + 'static>(
    thread: &T,
    object: &Value,
) -> Result<Arc<Class>> {
    {
