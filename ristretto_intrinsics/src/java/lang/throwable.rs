...
#[async_method]
pub async fn fill_in_stack_trace<T: ristretto_types::Thread + 'static>(
    thread: Arc<T>,
...
#[async_method]
pub async fn get_stack_trace_depth<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
...
#[async_method]
pub async fn get_stack_trace_element<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
