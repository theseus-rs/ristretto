...
pub fn end_print_raw_data<T: Thread + 'static>(
    _thread: Arc<T>,
...
pub fn print_raw_data<T: Thread + 'static>(
    _thread: Arc<T>,
...
pub fn start_print_raw_data<T: Thread + 'static>(
    _thread: Arc<T>,
    mut parameters: Parameters,
) -> Result<Option<Value>> {
...
mod tests {
    ...
    async fn test_end_print_raw_data() {
        ...
        let result = end_print_raw_data(thread, Parameters::default());
        assert_eq!(
