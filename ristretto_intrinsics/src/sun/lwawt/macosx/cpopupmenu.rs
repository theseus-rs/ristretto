...
pub fn native_create_popup_menu<T: Thread + 'static>(
    _thread: Arc<T>,
...
pub fn native_show_popup_menu<T: Thread + 'static>(
    _thread: Arc<T>,
...
mod tests {
    ...
    async fn test_native_create_popup_menu() {
        ...
        let result = native_create_popup_menu(thread, Parameters::default());
        assert_eq!(
