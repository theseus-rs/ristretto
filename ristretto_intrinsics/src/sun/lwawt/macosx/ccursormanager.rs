...
pub fn native_get_cursor_position<T: Thread + 'static>(
    _thread: Arc<T>,
...
pub fn native_set_allows_cursor_set_in_background<T: Thread + 'static>(
    _thread: Arc<T>,
...
pub fn native_set_built_in_cursor<T: Thread + 'static>(
    _thread: Arc<T>,
    mut parameters: Parameters,
) -> Result<Option<Value>> {
...
pub fn native_set_custom_cursor<T: Thread + 'static>(
    _thread: Arc<T>,
    mut parameters: Parameters,
) -> Result<Option<Value>> {
...
mod tests {
    ...
    async fn test_native_get_cursor_position() {
        ...
        let result = native_get_cursor_position(thread, Parameters::default());
        assert_eq!(
            "sun.lwawt.macosx.CCursorManager.nativeGetCursorPosition()Ljava/awt/geom/Point2D;",
