...
#[async_method]
pub async fn init_robot<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
...
#[async_method]
pub async fn key_event<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn mouse_event_0<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn mouse_event_1<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn mouse_wheel<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn native_get_screen_pixels_0<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn native_get_screen_pixels_1<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
