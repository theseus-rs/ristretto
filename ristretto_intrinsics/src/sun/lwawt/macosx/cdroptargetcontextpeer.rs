...
#[async_method]
pub async fn add_transfer<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
...
#[async_method]
pub async fn drop_done<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
...
#[async_method]
pub async fn start_transfer<T: ristretto_types::Thread + 'static>(
    _thread: Arc<T>,
    _parameters: Parameters,
) -> Result<Option<Value>> {
