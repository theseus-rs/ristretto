...
mod tests {
    ...
    fn test_illegal_monitor_state_exception() {
        let error =
            JavaError::IllegalMonitorStateException("Unable to release monitor".to_string());
        assert_eq!(error.class_name(), "java.lang.IllegalMonitorStateException");
        assert_eq!(error.message(), "Unable to release monitor");
    }
    ...
    fn test_interrupted_exception() {
        let error = JavaError::InterruptedException("Thread was interrupted".to_string());
        assert_eq!(error.class_name(), "java.lang.InterruptedException");
        assert_eq!(error.message(), "Thread was interrupted");
    }
