...
//!
//! This module provides a comprehensive error type system for the Ristretto VM, handling various
//! error conditions that can occur during class loading, verification, execution, and other
//! VM operations.
//!
//! The central type is [`Error`], which encompasses all possible error conditions. The module also
//! provides a type alias [`Result<T>`](Result) for convenience.
